import 'package:carousel_slider/app_carousel_slider.dart';
...
class _ManuallyControlledSliderState extends State<ManuallyControlledSlider> {
  final AppCarouselController _controller = AppCarouselController();
          ...
          child: Column(
            children: <Widget>[
              CarouselSlider(
                items: imageSliders,
                options:
                    AppCarouselOptions(enlargeCenterPage: true, height: 200),
