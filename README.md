...
```dart
CarouselSlider(
  options: AppCarouselOptions(height: 400.0),
...
Since `v2.0.0`, you'll need to pass the options to `AppCarouselOptions`. For each option's usage you can refer to [carousel_options.dart](./lib/carousel_options.dart).
